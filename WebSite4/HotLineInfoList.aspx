<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HotLineInfoList.aspx.cs" Inherits="HotLineInfoList" %>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td bgcolor="#D8D8D8" class="red" style="height: 24px">&nbsp;&nbsp;&nbsp;热门旅游线路展示</td>
                                    ...
                                    <tr>
                                        <td>
                                            <a class="highlightit" href='ShowLineInfo.aspx?id=<%#Eval("LineID") %>'>
                                                <img alt="" border="0" src='<%#Eval("LinePhoto")%>' style="width: 223px; height: 151px" /></a></td>
                                    </tr>
                                    <tr>
                                        <td>
