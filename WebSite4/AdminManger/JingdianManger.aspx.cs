...
using System.IO;
public partial class AdminManger_JingdianManger : System.Web.UI.Page
{
    ...
    protected void GvInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            mydata.RunSql("delete  from JingDian  where  id='" + ID + "'");
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [JingDian] ";
