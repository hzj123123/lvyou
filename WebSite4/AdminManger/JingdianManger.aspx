<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JingdianManger.aspx.cs" Inherits="AdminManger_JingdianManger" %>
                ...
                <td align="left" colspan="10" height="36">
                    &nbsp;<asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Price" HeaderText="预估费用" SortExpression="Price" />
                            <asp:TemplateField HeaderText="修改">
                                <ItemTemplate>  
                                
                                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# "XGJingdian.aspx?id="+Eval("id") %>'
