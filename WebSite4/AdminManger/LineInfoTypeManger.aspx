<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LineInfoTypeManger.aspx.cs" Inherits="Admin_LineInfoTypeManger" %>
                    ...
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyLineType.aspx?id="+Eval("id") %>'
