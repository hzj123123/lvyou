...
public partial class Admin_LineInfoTypeManger : System.Web.UI.Page
{
    ...
    protected void gvInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            mydata.RunSql("delete  from LineInfotype  where  id='" + ID + "'");
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [LineInfotype] ";
    ...
    {
        data.RunSql("insert into LineInfotype(name)values('" + txtname.Text + "')");
        Alert.AlertAndRedirect("添加成功", "LineInfoTypeManger.aspx");
