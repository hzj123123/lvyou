<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddLineInfo.aspx.cs" EnableEventValidation="false" ValidateRequest="false"  Inherits="AdminManger_AddLineInfo" %>
        ...
        <table align="center" bgcolor="#e3ebfe" border="0" cellpadding="2" cellspacing="1"
            ...
            <tr bgcolor="#e7e7e7">
                <td colspan="10" height="24">
                    旅游线路名称：<asp:TextBox ID="title" runat="server" Style="border-right: #ffcc00 1px solid;
                        border-top: #ffcc00 1px solid; border-left: #ffcc00 1px solid; border-bottom: #ffcc00 1px solid"
                        Width="341px"></asp:TextBox></td>
            </tr>
            <tr bgcolor="#e7e7e7">
                <td colspan="10" height="24">
                    旅游线路类别：<asp:DropDownList ID="DropDownList1" runat="server" Width="213px">
                    </asp:DropDownList></td>
            </tr>
            <tr bgcolor="#e7e7e7">
                <td colspan="10" style="height: 24px">
                    线路报价：<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox></td>
            </tr>
