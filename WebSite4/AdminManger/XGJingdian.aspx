<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XGJingdian.aspx.cs"  ValidateRequest="false" EnableEventValidation="false"   Inherits="AdminManger_XGJingdian" %>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="center" colspan="2" style="height: 19px">
                                <asp:Button ID="btn_value" runat="server" OnClick="btnSubmit_Click" Text="修改" Width="59px" />
                                &nbsp;&nbsp; &nbsp; &nbsp;</td>
                        </tr>
                    </table>
                    </td>
