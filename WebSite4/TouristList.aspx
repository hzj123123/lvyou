<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TouristList.aspx.cs" Inherits="TouristList" %>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td bgcolor="#D8D8D8" class="red" style="height: 24px">&nbsp;&nbsp;旅游景点信息</td>
                        ...
                        <asp:DataList ID="DataList2" runat="server" RepeatColumns="3" RepeatDirection="Horizontal"
                            ...
                            <ItemTemplate>
                                <table>
                                    <tr>
                                        <td>
                                            <a class="highlightit" href='ShowTouristInfo.aspx?id=<%#Eval("id") %>'>
                                                <img alt="" border="0" src='<%#Eval("Photo")%>' style="width: 223px; height: 151px" /></a></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href='ShowTouristInfo.aspx?id=<%#Eval("id") %>'>
                                                <%#Eval("Name")%>
                                            </a>
                                        </td>
                                    </tr>
