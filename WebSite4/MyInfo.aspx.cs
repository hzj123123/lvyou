...
public partial class MyInfo : System.Web.UI.Page
{
    ...
    {
        sql = "update Member set MemberName='" + txtLoginName.Text.ToString().Trim()
             + "',MemberTName='" + txtTName.Text
             + "',MemberPhone='" + txtTel.Text
             + "',MemberEmail='" + txtEmail.Text
             
             + "' ,MemberAddress='" + txtAddress.Text
             + "',MemberSex='" + ddlSex.SelectedValue
             + "',MemberCity='" + ddlCity.SelectedItem.Text
             + "',MemberWenTi='" + DropDownList1.SelectedValue
             + "',MemberDaAn='" + txtdanan.Text
             + "'  where MemberID=" + dID;
        data.RunSql(sql);
