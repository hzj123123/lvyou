<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FindPwdNext.aspx.cs" Inherits="FindPwdNext" %>
      ...
      <tr>
        ...
        <tr>
            <td align="center" style="height: 36px">
                密码问题：<asp:DropDownList ID="DropDownList1" runat="server" Width="113px">
                ...
                密码答案：<asp:TextBox ID="TextBox2" runat="server"
                        CssClass="label" Width="138px"></asp:TextBox>
